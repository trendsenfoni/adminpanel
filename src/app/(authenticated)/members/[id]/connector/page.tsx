...
export default function ConnectorPage({ params }: Props) {
  ...
  const save = () => {
    putItem(`/admin/memberSettings/${params?.id}`, admintoken, {
      connector: connector
    })
      .then(result => {
            ...
            <div>
              {!testResult && <>
                <Button
                  ...
                  onClick={() => {
                    postItem(`/admin/memberSettings/connectorTest`, admintoken, { clientId: connector.clientId, clientPass: connector.clientPass })
            ...
            <div>
              {!testResult && <>
                <Button
                  variant="secondary"
                  onClick={() => {
                    postItem(`/admin/memberSettings/mssqlTest`, admintoken, {
  ...
  useEffect(() => {
    if (admintoken) {
      getItem(`/admin/memberSettings/${params?.id}`, admintoken)
        .then(result => {
