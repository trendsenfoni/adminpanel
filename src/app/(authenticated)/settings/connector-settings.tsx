            ...
            <div>
              {!testResult && <>
                <Button
                  ...
                  onClick={() => {
                    postItem(`/settings/connectorTest`, admintoken, { clientId: connector.clientId, clientPass: connector.clientPass })
